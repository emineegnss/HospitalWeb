<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="HospitalWeb.ForgorPassword" %>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	              ...
	              <input type="password" class="form-control" placeholder="Numara" required>
	            </div>
	            ...
	            <div class="form-group">
           <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" type="button" class="btn btn-danger" style="background-color:#FFEBEE;font-weight:900; color:black; width : 298px; height: 48px" Text="Kod Gönder"/>
       </div>
