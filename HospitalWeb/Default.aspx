<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HospitalWeb.Hospital" %>
   ...
   <section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group d-md-flex" style="left: 136px; top: 1px">

					  <div  class="w-50 text-md-right">
							 &nbsp;&nbsp; <a href="https://localhost:44352/ForgotPassword.aspx">Parolamı unuttum</a>
								</div>
	            ...
	            <div class="form-group">
           <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" type="button" class="btn btn-danger" style="background-color:#FFEBEE;font-weight:900; color:black; width : 298px; height: 48px" Text="Giriş Yap"/>
       </div>
